...
const ptBR = {
  ...
  not_found_description: 'O endereço acessado não existe ou foi alterado.',
  products_page_description: 'Catálogo completo da loja, com busca e filtros.',
...
const en: Partial<Record<TranslationKey, string>> = {
  ...
  not_found_description: 'This address does not exist or has changed.',
  products_page_description: 'Full store catalog, with search and filters.',
